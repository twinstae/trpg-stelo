...
export const DW2_CHAPTERS: Dw2ChapterMeta[] = [
  { slug: "00-front-matter", titleEn: "Front Matter", titleKo: "머리말", part: "머리말", status: "pending" },
  ...
  { slug: "behind-the-screen", titleEn: "Behind the Screen", titleKo: "화면 뒤에서", part: "마스터", status: "pending" },
  { slug: "agenda-and-principles", titleEn: "Agenda & Principles", titleKo: "강령과 원칙", part: "마스터", status: "pending" },
  { slug: "gm-moves", titleEn: "GM Moves", titleKo: "마스터 액션", part: "마스터", status: "pending" },
  { slug: "preparing-a-session", titleEn: "Preparing a Session", titleKo: "세션 준비", part: "마스터", status: "pending" },
  { slug: "major-npcs", titleEn: "Major NPCs", titleKo: "주요 NPC", part: "마스터", status: "pending" },
  { slug: "npc-traits", titleEn: "NPC Traits", titleKo: "NPC 특성 예시", part: "마스터", status: "pending" },
  { slug: "threats", titleEn: "Threats", titleKo: "위협", part: "마스터", status: "pending" },
  { slug: "magic-items", titleEn: "Magic Items", titleKo: "마법 아이템", part: "마스터", status: "pending" },
  { slug: "example-magic-items", titleEn: "Example Magic Items", titleKo: "마법 아이템 예시", part: "마스터", status: "pending" },
  { slug: "campaign-moves", titleEn: "Campaign Moves", titleKo: "캠페인 액션", part: "캠페인", status: "pending" },
  { slug: "bonds", titleEn: "Bonds", titleKo: "유대", part: "캠페인", status: "pending" },
  { slug: "struggles", titleEn: "Struggles", titleKo: "갈등", part: "캠페인", status: "pending" },
  { slug: "example-struggles", titleEn: "Example Struggles", titleKo: "갈등 예시", part: "캠페인", status: "pending" },
  { slug: "treasure-and-wealth", titleEn: "Treasure & Wealth", titleKo: "재물과 부", part: "캠페인", status: "pending" },
  { slug: "the-stolen-children", titleEn: "The Stolen Children", titleKo: "빼앗긴 아이들", part: "작은 모험", status: "pending" },
];

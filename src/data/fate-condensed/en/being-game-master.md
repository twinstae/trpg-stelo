...
- **Script Change RPG Toolbox**: For something with a bit more nuance and granularity, look to Script Change by Beau Jager Sheldon, which provides options to pause, rewind, skip ahead, and more using an accessibly familiar media-player metaphor. Learn more about Script Change at http://tinyurl.com/nphed7m

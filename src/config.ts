...
export const SIDEBAR: Sidebar = {
  ko: Language("ko", [
    ...
    Topic("던전월드 2", "/awe/dw2", [
      ...
      { text: "안전 도구", link: "/safety-tools" },
      { text: "세션 제로", link: "/session-zero" },
      { text: "캐릭터 만들기", link: "/character-creation" },
      { text: "모험 액션", link: "/adventure-moves" },
      { text: "캐릭터 액션", link: "/character-moves" },
      { text: "전투", link: "/combat" },
      { text: "전투 액션", link: "/battle-moves" },
      { text: "상품·서비스 예시", link: "/example-goods-and-services" },
      { text: "태그", link: "/tags" },
      { text: "무기와 방어구", link: "/arms-and-armor" },
      { text: "일반 장비", link: "/general-equipment" },
      { text: "마법", link: "/magic" },
      { text: "「시체를 뒤진다」", link: "/i-loot-the-body" },
      { text: "야만인", link: "/the-barbarian" },
      { text: "음유시인", link: "/the-bard" },
      { text: "성직자", link: "/the-cleric" },
      { text: "드루이드", link: "/the-druid" },
      { text: "파이터", link: "/the-fighter" },
      { text: "성기사", link: "/the-paladin" },
      { text: "레인저", link: "/the-ranger" },
      ...
      { text: "유대", link: "/bonds" },
      { text: "특수 유대", link: "/special-bonds" },
      { text: "마법 아이템", link: "/magic-items" },
      { text: "커스텀 마법 아이템", link: "/custom-magic-items" },
      { text: "마법 잡화", link: "/magic-trinkets" },
      { text: "유물", link: "/artifacts" },
      { text: "게임 마스터", link: "/the-game-master" },
      { text: "아젠다와 원칙", link: "/agendas-and-principles" },
      { text: "준비", link: "/preparation" },
      { text: "GM 액션 상세", link: "/gm-move-details" },
      { text: "장면", link: "/scenes" },
      { text: "장소", link: "/locations" },
      { text: "NPC", link: "/npcs" },
      { text: "NPC 예시", link: "/npc-examples" },
      { text: "NPC 특성 예시", link: "/npc-sample-traits" },
      { text: "위협", link: "/threats" },
      { text: "던전", link: "/dungeons" },
      { text: "GM 레퍼런스", link: "/gm-reference" },
    ]),

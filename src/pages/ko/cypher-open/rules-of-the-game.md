...
마스터 개입은 [_사이퍼 시스템을 운영하는 법_](/ko/cypher-open/running-the-cypher-system)에서 더 자세히 다루지만, 핵심은 상황을 더 복잡하게 만드는 예기치 못한 요소가 끼어드는 것입니다. 캐릭터가 반드시 실수했기 때문은 아닙니다. 일 자체에서 뜻밖의 변수가 튀어나오거나, 현재 장면과 연관된 외부 요인이 개입하는 것일 수도 있습니다.

예를 들어 방어 굴림에서 마스터 개입이 발생하면, 순수 1의 결과로 적의 행운의 일격이 들어가 피해를 2점 더 받을 수도 있습니다.

(마스터 개입의 상세 규칙과 운용 요령은 [_사이퍼 시스템을 운영하는 법_](/ko/cypher-open/running-the-cypher-system)을 참고하십시오.)
...
공격은 수치 처리만 하지 말고 장면 묘사를 적극적으로 붙이는 것이 좋습니다. 명중은 팔을 스치는 찌르기로, 실패는 벽에 칼날이 박히는 연출로 풀어낼 수 있습니다. 돌진, 막기, 숙이기, 회전, 도약 같은 동작이 전투를 더 선명하고 긴장감 있게 만듭니다. 이 부분은 [_사이퍼 시스템을 운영하는 법_](/ko/cypher-open/running-the-cypher-system)에 더 자세히 나와 있습니다.
...
(차량에 관한 자세한 내용은 [_장르_](/ko/cypher-open/genres)를 참고하십시오.)
...
(마스터 개입에 관한 더 자세한 내용은 [_사이퍼 시스템을 운영하는 법_](/ko/cypher-open/running-the-cypher-system)을 참고하십시오.)

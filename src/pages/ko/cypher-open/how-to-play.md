...
경험치는 보통 캐릭터의 성장(advancement)을 위해 쓰이지만 (더 자세히는, [*캐릭터 만들기*](/ko/cypher-open/creating-your-character) 장을 보십시오.), 플레이어는 1XP를 써서 어떤 주사위 판정도 다시 굴릴 수 있고 두 판정 중에 더 좋은 결과를 선택할 수 있습니다.

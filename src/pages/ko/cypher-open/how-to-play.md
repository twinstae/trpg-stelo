...
또한 캐릭터는 *분발*을 써서 난이도를 더 낮출 수 있습니다. (분발은 [게임의 규칙](/ko/cypher-open/rules-of-the-game#분발-effort)에서 자세히 다룹니다.)
...
주사위를 굴리지 않으면 실패할 위험도 없지만, 특수 효과를 얻을 기회도 없습니다. (순수 19, 20의 효과는 [게임의 규칙](/ko/cypher-open/rules-of-the-game#특수-효과-special-rolls)을 참조하세요.)

...
**지근거리** 는 캐릭터에게 닿거나 몇 걸음 안입니다. 작은 방에 서 있으면 방 안의 모든 것이 지근거리 안에 있습니다. 지근거리는 많아야 3m(10피트)입니다.

**단거리** 는 지근거리보다 멀고 대략 15m(50피트) 미만입니다.

**장거리** 는 단거리보다 멀고 대략 30m(100피트) 미만입니다.

**초장거리(very long) 거리** 는 장거리보다 멀고 대략 150m(500피트) 미만입니다.

그보다 더 멀면 거리를 항상 구체적으로 말합니다—300m(1000피트), 1.6km(1마일) 등.
...
예를 들어 PC들이 아휴먼 무리와 싸울 때, 난전에서는 누구든 아무 아휴먼이나 공격할 수 있을 만큼 모두 지근거리 안에 있다고 볼 수 있습니다. 정확한 위치는 중요하지 않습니다. 전투 중 생물은 어차피 계속 움직입니다. 다만 아휴먼 하나가 뒤에 남아 쇠뇌를 쓴다면, 그 적을 공격하려면 단거리만큼 가는 데 행동 전체를 써야 할 수 있습니다. 아휴먼이 6m(20피트)든 12m(40피트)든 단거리로만 보면 됩니다. 15m(50피트)보다 멀면 장거리 이동이 필요하다는 점은 중요합니다.

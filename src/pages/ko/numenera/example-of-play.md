...
createdAt: "2022-11-23T07:34:17.231Z"
publish: true
---
...
> **루:** 네. 그려면 _목표치_ 6 이상이 나오면 되죠? 굴려볼게요. (13이 나온다)
>
...
난이도를 낮추는 방법이 또 있는데. 바로 *분발*입니다. 분발은 해당하는 _역량_ 점수를 깎는 대신 난이도를 낮출 수 있습니다. 이야기 속에서는 캐릭터가 긴장된 상황에서 더 노력을 들이고, 자기 능력을 최대한 발휘하는 걸 뜻합니다.
...
앞서 이야기한 것처럼 누메네라는 사이퍼 시스템 룰을 사용하고, 사이퍼 시스템의 꽃은 [사이퍼](/ko/cypher-open/cyphers/)입니다! 사이퍼는 1회용 능력으로, 물리적 형태가 있는 아이템일 수도 있고, 우연이나 초자연적인 능력일 수도 있습니다.
...
>
> **시샤(미래지향적인 라이트이며 내일을 건설한다):** 혹시 멀쩡해 보이는 누메네라 중에 무기도 있을까요. 빠르게훝어보겠습니다.
>
> **마스터:** 다양한 누메네라들이 보여요. 원래 무기인지는 모르겠지만. 광선 쏘는 것. 음파를 만드는 것. 다양한 것들이 있는데... 아니 이런 무기처럼 보이는 애들은 다들 반파되어 있습니다.
>
> **시샤:** 그러고보니 **수리 유닛**으로 고장난 누메네라를 고칠 수도 있군요. 공격 무기를 고쳐서 싸워보겠습니다
>
